  ...
  return (
    ...
    >
      ...
      <Trans i18nKey='ResultSymptomaticTestDescription6'>
        <p>
          ...
          <a
            ...
            target='_blank'
          >
            Find out if you may benefit from treatment
          </a>
        </p>
        <p>
          <b>
      ...
      <Trans i18nKey='ResultSymptomaticTestNotice'>
        <p>
          <b>Pay attention to how you're feeling.</b> If your symptoms change, you should get health
          advice:
        </p>
        ...
        <p>
          ...
          or emergency department right away if you start to feel very sick - for example, if it
          gets hard to breathe or you can't drink anything.
        </p>
      </Trans>
    </ResultPageLayout>
  );
